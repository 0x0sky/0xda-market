  ...
  module Market
    module Pricing
      class Service
        ...
        def apply_price(sku:, amount_usdt:, source: "admin", set_by_telegram_user_id: nil)
          apply_prices(
            [{ "sku" => sku, "amount_usdt" => amount_usdt }],
            source: source,
            set_by_telegram_user_id: set_by_telegram_user_id
          ).first
        end
        ...
        def apply_prices(entries, source: "admin", set_by_telegram_user_id: nil)
